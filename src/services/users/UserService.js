...
function create_user({username, first_name, last_name, profile_photo_url, cover_photo_url, claim_page_photo_url, bio, user_twitter_link, user_clubhouse_link, user_instagram_link, user_website_link, user_tiktok_link, user_youtube_link, user_vimeo_link, user_main_contact_email, user_main_contact_phone, dob, dob_month, dob_day, dob_year, gender, gender_id}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const query = DatabaseService.generate_query({username, first_name, last_name, profile_photo_url, cover_photo_url, claim_page_photo_url, bio, user_twitter_link, user_clubhouse_link, user_instagram_link, user_website_link, user_tiktok_link, user_youtube_link, user_vimeo_link, user_main_contact_email, user_main_contact_phone, dob, dob_month, dob_day, dob_year, gender, gender_id});
...
function edit_user({user_id, username, first_name, last_name, profile_photo_url, cover_photo_url, claim_page_photo_url, bio, user_twitter_link, user_clubhouse_link, user_instagram_link, user_website_link, user_tiktok_link, user_youtube_link, user_vimeo_link, user_main_contact_email, user_main_contact_phone, dob, dob_month, dob_day, dob_year, gender, gender_id}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const query = {username, first_name, last_name, profile_photo_url, cover_photo_url, claim_page_photo_url, bio, user_twitter_link, user_clubhouse_link, user_instagram_link, user_website_link, user_tiktok_link, user_youtube_link, user_vimeo_link, user_main_contact_email, user_main_contact_phone, dob, dob_month, dob_day, dob_year, gender, gender_id };
