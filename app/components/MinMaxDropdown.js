...
class MinMaxDropdown extends React.Component {
    ...
    render() {
        let { classes, label, placeholder, update,
            min_value, min_value_label, max_value, max_value_label,
                ...
                <div style={{display: "flex", height: "100%", flexDirection: "column"}}>
                    ...
                    <div style={{flex: 1, padding: "8px 12px", overflowY: "scroll", maxHeight: "183px"}}>
                        <div className={classes.ratingsContainer}>
                            ...
                            <StandardSelect value={min_value} options={options} update={(val) => update(min_value_label, val)} />
                            <div style={{height: "8px", width: "100%"}}/>
                            <div className={classes.ratingsLabel}>Max</div>
                            <StandardSelect value={max_value} options={options} update={(val) => update(max_value_label, val)} />
                        </div>
                    </div>
                </div>
            </div>}
...
export default withApollo(withRouter(injectSheet(Styles)(MinMaxDropdown)));
