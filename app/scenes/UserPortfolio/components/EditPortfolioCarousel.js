...
class EditPortfolioCarousel extends React.Component {
    ...
    render() {
        let { classes, user_galleries, height, portfolioLinkRef, onEdit} = this.props;
        ...
        return (
            <div className={classes.container}>
                ...
                <div className={mc(classes.editToggleDeleteFloatingContainer)} style={{border: `1px solid ${COMMON.COLORS.LIGHT_GREY}`}}>
                    <div className={mc(classes.editToggleDeleteContainer)}>
                        <div style={{margin: 0, padding: 0}} className={mc(classes.editToggleDeleteEdit)} onClick={() => {onEdit ? onEdit() : null}}>
...
export default withApollo(withRouter(injectSheet(Styles)(EditPortfolioCarousel)));
