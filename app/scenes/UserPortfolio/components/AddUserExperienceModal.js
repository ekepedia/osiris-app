...
class AddUserExperienceModal extends React.Component {
                            ...
                            <div style={{display: "flex"}}>
                                <div className={classes.smallThumbnailContainer}>
                                    ...
                                    <div className={classes.smallThumbnailHolder}>
                                        <ThumbnailUpload url={this.state.company_logo_url} onURL={({url, file_name}) => {
                                            this.setState({
                                ...
                                <div style={{flex: 1}}>
                                    ...
                                    <StandardInput value={company_name} update={(v) => (this.setState({company_name: v}))} />
                                    <div className={classes.inputLabel}>Role</div>
...
export default withApollo(withRouter(injectSheet(Styles)(AddUserExperienceModal)));
