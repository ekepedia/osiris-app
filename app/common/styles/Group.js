...
const GroupRowStyles = {
    ...
    groupOverallGlassdoorContainer: {
        flex: 1,
    },
    groupWorkGlassdoorContainer: {
        flex: 1,
        '@media (max-width: 1250px)': {
            display: "none"
        },
    },
    groupPayGlassdoorContainer: {
        flex: 1,
